...
{
    public var labeled_functions:Map<String, Dynamic> = [];

	public function runLabeledFunction(function_name:String, ?args:Map<String, Dynamic>):Dynamic
	{
		return labeled_functions.get('$function_name')(args) ?? null;
	}

	public function addLabeledFunction(function_name:String, function_function:Dynamic)
	{
		labeled_functions.set('$function_name', function_function);
	}
